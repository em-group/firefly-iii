...
Route::permanentRedirect('/unsubscribe', '/unsub');
 ...
 */
Route::group(
    ['middleware' => 'admin', 'namespace' => 'FireflyIII\Http\Controllers', 'prefix' => 'currencies', 'as' => 'currencies.'],
    static function () {
 ...
 */
Route::group(
    ['middleware' => 'user-full-auth', 'namespace' => 'FireflyIII\Http\Controllers', 'prefix' => 'membership', 'as' => 'membership.'],
    static function () {
