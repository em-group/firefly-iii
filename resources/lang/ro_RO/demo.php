...
return [
    ...
    'reports-index-start'    => config('app.name').' acceptă o serie de tipuri de rapoarte. Citiți despre ele făcând clic pe iconița <i class="fa fa-question-circle"></i> din colțul din dreapta sus.',
    ...
    'currencies-index'       => config('app.name').' acceptă mai multe monede. Deși EURO este moneda implicită, acesta poate fi schimbată în Dolar, RON și multe alte valute. După cum vedeți, o mică selecție de valute a fost inclusă, dar puteți adăuga propria dvs. monedă dacă doriți. Schimbarea monedei prestabilite nu va schimba însă moneda tranzacțiilor existente: Firefly III acceptă simultan utilizarea mai multor monede.',
