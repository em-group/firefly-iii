...
return [
    // index
    'index_intro'                           => 'Bem-vindo à página de inicial do '.config('app.name').'. Por favor, aproveite esta introdução para verificar como funciona o '.config('app.name').'.',
    ...
    'index_outro'                           => 'A maioria das páginas do '.config('app.name').' começará com uma pequena turnê como esta. Entre em contato comigo quando tiver dúvidas ou comentários. Vamos lá!',
    ...
    'accounts_create_asset_opening_balance' => 'As contas de bens podem ter um "saldo de abertura", indicando o início do histórico desta conta no '.config('app.name').'.',
    'accounts_create_asset_currency'        => config('app.name').' suporta múltiplas moedas. As contas de ativos têm uma moeda principal, que você deve definir aqui.',
    ...
    // budgets index
    'budgets_index_intro'                   => 'Os orçamentos são usados ​​para gerenciar suas finanças e formar uma das principais funções do '.config('app.name').'.',
    'budgets_index_set_budget'              => 'Defina seu orçamento total para todos os períodos, de modo que o '.config('app.name').' possa lhe dizer se você orçou todo o dinheiro disponível.',
    ...
    // rules index
    'rules_index_intro'                                       => 'O '.config('app.name').' permite que você gerencie as regras, que serão automaticamente aplicadas a qualquer transação que você crie ou edite.',
    ...
    // currencies
    'currencies_index_intro'                                  => config('app.name').' suporta múltiplas moedas, que você pode alterar nesta página.',
    'currencies_index_default'                                => config('app.name').' tem uma moeda padrão.',
