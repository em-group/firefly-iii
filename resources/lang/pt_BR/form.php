...
return [
    ...
    'user_areYouSure'             => 'Se você excluir o usuário ":email", tudo desaparecerá. Não será possível desfazer a ação. Se excluir você mesmo, você perderá acesso total a essa instância do '.config('app.name').'.',
    ...
    'permDeleteWarning'           => 'Exclusão de dados do '.config('app.name').' são permanentes e não podem ser desfeitos.',
    ...
    'local_account'         => 'Conta no '.config('app.name'),
