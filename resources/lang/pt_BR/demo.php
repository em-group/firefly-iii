...
return [
    ...
    'reports-index-start'    => config('app.name').' suporta vários tipos de relatórios. Leia sobre eles clicando no<i class="fa fa-question-circle"></i>-ícone no canto superior direito.',
    ...
    'currencies-index'       => config('app.name').' oferece suporte a várias moedas. Embora o padrão seja o Euro, ela pode ser definida para o dólar americano e muitas outras moedas. Como você pode ver uma pequena seleção de moedas foi incluída, mas você pode adicionar suas próprias se desejar. No entanto, alterar a moeda padrão não vai mudar a moeda de transações existentes: '.config('app.name').' suporta o uso de várias moedas ao mesmo tempo.',
