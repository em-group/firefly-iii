...
return [
    ...
    'user_areYouSure'             => '如果您刪除使用者 ":email"，該名使用者的任何資訊均會消失，無法復原。如果您刪除自己，將無法進入此 '.config('app.name').' 版本。',
    ...
    'permDeleteWarning'           => '自 '.config('app.name').' 刪除項目是永久且不可撤銷的。',
    ...
    'local_account'         => config('app.name').' 帳戶',
    'from_date'             => '開始自',
    'to_date'               => '日期至',
