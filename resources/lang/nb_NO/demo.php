...
return [
    ...
    'reports-index-start'    => config('app.name').' støtter en rekke typer rapporter. Les om dem ved å klikke på <i class="fa fa-question-circle"></i>-ikonet øverst i høyre hjørne.',
    ...
    'currencies-index'       => config('app.name').' støtter flere valutaer. Selv om Euro er standard, kan det settes til norske kroner, eller en av mange andre valutaer. Som du kan se, så er et lite utvalg valutaer allerede lagt inn, men du kan legge til flere hvis du vil. Hvis du endrer standardvalutaen, endres ikke valutaen for eksisterende transaksjoner, men '.config('app.name').' støtter bruken av flere valutaer samtidig.',
    ...
    'import-index'           => 'Alle CSV-filer kan importeres til '.config('app.name').'. Den støtter også import av data fra bunq og Spectre. Andre banker og finansielle aggregatorer vil bli implementert i fremtiden. Men som en demo-bruker kan du bare se en "falsk"-leverandør i aksjon. Den vil generere noen tilfeldige transaksjoner for å vise hvordan prosessen fungerer.',
