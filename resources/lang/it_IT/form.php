...
return [
    ...
    'user_areYouSure'             => 'Se cancelli l\'utente ":email", verrà eliminato tutto. Non sarà più possibile recuperare i dati eliminati. Se cancelli te stesso, perderai l\'accesso a questa istanza di '.config('app.name').'.',
    ...
    'permDeleteWarning'           => 'L\'eliminazione dei dati da '.config('app.name').' è definitiva e non può essere annullata.',
    ...
    'local_account'         => 'Conto '.config('app.name'),
