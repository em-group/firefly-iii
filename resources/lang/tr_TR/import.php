...
return [
    ...
    // index page:
    'general_index_intro'                 => 'Firefly aktarım programına hoş geldiniz. '.config('app.name').' içine dosya aktarmanın burada bir kaç yolu var, burada olarak görüntülenmekte.',
