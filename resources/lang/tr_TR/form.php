...
return [
    ...
    'user_areYouSure'             => '":email" kullanıcısını silerseniz her şey gitmiş olacak. Geriye alma, silmeyi iptal etme veya başka bir şey yoktur. Eğer kendinizi silerseniz, bu '.config('app.name').'\'e erişiminizi kaybedersiniz.',
