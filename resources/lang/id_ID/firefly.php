...
return [
    ...
    'two_factor_lost_fix_self'                   => 'Jika Anda menjalankan contoh '.config('app.name').' Anda sendiri, periksa log di <code>storage / logs</code> untuk mendapatkan petunjuk.',
    ...
    'need_more_help'                             => 'Jika Anda memerlukan bantuan lebih banyak menggunakan '.config('app.name').', silakan <a href="https://github.com/firefly-iii/firefly-iii/issues">opsi tiket di Github</a>.',
    ...
    'cannot_redirect_to_account'                 => config('app.name').' tidak bisa mengalihkan Anda ke halaman yang benar. Permintaan maaf.',
    ...
    'invalid_locale_settings'                    => config('app.name').' tidak dapat memformat jumlah uang karena server Anda kehilangan paket yang dibutuhkan. Ada <a href="https://github.com/firefly-iii/help/wiki/Missing-locale-packages">instructions bagaimana melakukan ini</a>.',
    ...
    'search_box_intro'                           => 'Selamat datang di fungsi pencarian '.config('app.name').'. Masukkan kueri penelusuran Anda di dalam kotak. Pastikan Anda memeriksa file bantuan karena pencariannya cukup canggih.',
    ...
    'include_old_uploads_help'                   => config('app.name').' tidak membuang file CSV asli yang telah Anda impor sebelumnya. Anda bisa memasukkannya ke dalam ekspor Anda.',
    'do_export'                                  => 'Ekspor',
    ...
    'apply_rule_selection_intro'                 => 'Aturan seperti ":title" biasanya hanya diterapkan pada transaksi baru atau yang telah diperbarui, namun Anda bisa memberi tahu '.config('app.name').' untuk menjalankannya pada pilihan transaksi Anda yang ada. Ini bisa berguna bila Anda telah memperbarui peraturan dan Anda memerlukan perubahan yang akan diterapkan pada semua transaksi Anda yang lain.',
    ...
    'pref_languages_help'                     => config('app.name').' mendukung beberapa bahasa. Mana yang kamu suka?',
    ...
    'delete_your_account_help'                => 'Menghapus akun juga akan menghapus akun, transaksi, <em>semua</em> Anda mungkin telah disimpan ke '.config('app.name').'. Ini akan HILANG.',
    ...
    'currencies_intro'                        => config('app.name').' mendukung berbagai mata uang yang dapat Anda atur dan aktifkan di sini.',
    ...
    'reconcile_has_more'                      => 'Buku '.config('app.name').' Anda memiliki lebih banyak uang di dalamnya dari bank Anda klaim Anda harus. Ada beberapa pilihan. Silahkan memilih apa yang harus dilakukan. Kemudian, tekan "Konfirmasi rekonsiliasi".',
    'reconcile_has_less'                      => 'Buku '.config('app.name').' Anda memiliki sedikit uang di dalamnya daripada bank Anda klaim Anda harus. Ada beberapa pilihan. Silahkan memilih apa yang harus dilakukan. Kemudian, tekan "Konfirmasi rekonsiliasi".',
    'reconcile_is_equal'                      => 'Buku '.config('app.name').' Anda dan pernyataan bank Anda cocok. Tidak ada hubungannya. Silahkan tekan "Konfirmasi rekonsiliasi" untuk mengkonfirmasi masukan Anda.',
    ...
    'to_get_started'                          => 'Senang melihat Anda berhasil memasang '.config('app.name').'. Untuk memulai dengan alat ini, harap masukkan nama bank dan saldo rekening giro utama Anda. Jangan khawatir jika Anda memiliki banyak akun. Anda bisa menambahkannya nanti. Hanya saja '.config('app.name').' butuh sesuatu untuk memulai.',
    'savings_balance_text'                    => config('app.name').' secara otomatis akan membuat rekening tabungan untuk Anda. Secara default, tidak akan ada uang di rekening tabungan Anda, tapi jika Anda memberi tahu '.config('app.name').', saldo itu akan disimpan seperti itu.',
    'finish_up_new_user'                      => 'Itu dia! Anda dapat melanjutkan dengan menekan <strong>Kirim</strong>. Anda akan dibawa ke indeks '.config('app.name').'.',
    ...
    'firefly_instance_configuration'        => 'Pilihan konfigurasi untuk '.config('app.name'),
    ...
    'sandstorm_not_available'               => 'Fungsi ini tidak tersedia saat Anda menggunakan '.config('app.name').' di dalam lingkungan Sandstorm.io.',
    ...
    'no_accounts_imperative_asset'          => 'Untuk mulai menggunakan '.config('app.name').' Anda harus membuat setidaknya satu akun aset. Mari kita lakukan sekarang:',
