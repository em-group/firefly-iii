...
return [
    ...
    'index_breadcrumb'                    => 'Importuj dane do '.config('app.name'),
    ...
    // index page:
    'general_index_intro'                 => 'Witamy w procedurze importu '.config('app.name').'. Istnieje kilka sposobów importowania danych do '.config('app.name').'.',
    ...
    'job_config_local_account_help'   => 'Wybierz konto '.config('app.name').' odpowiadające wybranemu powyżej kontu bankowemu.',
    // specifics:
