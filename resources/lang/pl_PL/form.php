...
return [
    ...
    'user_areYouSure'             => 'Jeśli usuniesz użytkownika ":email", wszystko zniknie. Nie ma cofania, przywracania ani czegokolwiek. Jeśli usuniesz siebie, stracisz dostęp do tej instalacji '.config('app.name').'.',
    ...
    'permDeleteWarning'           => 'Usuwanie rzeczy z '.config('app.name').' jest trwałe i nie można tego cofnąć.',
    ...
    'local_account'         => 'Konto '.config('app.name'),
    'from_date'             => 'Data od',
    'to_date'               => 'Data do',
