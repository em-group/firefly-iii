...
return [
    ...
    'reports-index-start'    => config('app.name').' obsługuje wiele typów raportów. Możesz przeczytać o nich klikając ikonę <i class="fa fa-question-circle"></i> w prawym górnym rogu.',
    ...
    'currencies-index'       => config('app.name').' obsługuje wiele walut. Chociaż domyślnie jest to euro, można go ustawić na dolara amerykańskiego i wiele innych walut. Jak widać niewielki wybór walut został uwzględniony, ale możesz dodać własne, jeśli chcesz. Zmiana domyślnej waluty nie zmieni waluty istniejących transakcji, jednak: '.config('app.name').' obsługuje korzystanie z wielu walut w tym samym czasie.',
