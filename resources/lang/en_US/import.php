...
return [
    ...
    'index_breadcrumb'                    => 'Import data into '.config('app.name'),
    ...
    // index page:
    'general_index_intro'                 => 'Welcome to '.config('app.name').'\'s import routine. There are a few ways of importing data into '.config('app.name').', displayed here as buttons.',
