...
return [
    ...
    'cancel_success' => 'Membership successfully cancelled',
    'reactivate_success' => 'Membership successfully reactivated',
    'reactivate_error' => 'An error occurred when attempting to reactivate your membership',
    'missing' => 'No membership registered',
    'withdrawn' => 'Withdrawn',
    'refunded' => 'Refunded',
    ...
    'change_instructions' => 'Changing your membership will charge your card immediately and set the new membership active from now and be renewed in :membership_length days.',
    'change_success' => 'Membership updated successfully! It may take a few minutes to display',
    'renew_frequency' => 'every :membership_length days',
    'update' => 'Update',
