...
return [
    ...
    'index'                  => 'Welcome to <strong>'.config('app.name').'</strong>! On this page you get a quick overview of your finances. For more information, check out Accounts &rarr; <a href=":asset">Asset Accounts</a> and of course the <a href=":budgets">Budgets</a> and <a href=":reports">Reports</a> pages. Or just take a look around and see where you end up.',
    ...
    'reports-index-start'    => config('app.name').' supports a number of types of reports. Read about them by clicking on the <i class="fa fa-question-circle"></i>-icon in the top right corner.',
    ...
    'currencies-index'       => config('app.name').' supports multiple currencies. Although it defaults to the Euro it can be set to the US Dollar and many other currencies. As you can see a small selection of currencies has been included but you can add your own if you wish to. Changing the default currency will not change the currency of existing transactions however: '.config('app.name').' supports the use of multiple currencies at the same time.',
