...
return [
    ...
    'index'                  => '¡Bienvenido a <strong>'.config('app.name').'</strong>! En esta página tendrá una vista rápida de sus finanzas. Para más información, mire sus cuentas &rarr; <a href=":asset">Cuentas de activos</a> y, por supuesto, las páginas de <a href=":budgets">presupuestos</a> e <a href=":reports">Informes</a>. O simplemente investigue la aplicación por su cuenta.',
    ...
    'reports-index-start'    => config('app.name').' da soporte a un buen numero de tipos de informes. Lea sobre ellos haciendo clic en el icono <i class="fa fa-question-circle"></i> en la esquina superior derecha.',
    ...
    'currencies-index'       => config('app.name').' admite múltiples monedas. A pesar de que la moneda por defecto es el Euro, se puede seleccionar el Dólar de EE. UU, y muchas otras monedas. Como se puede ver se ha incluido una pequeña selección de monedas, pero puede agregar su propia moneda si lo desea. Sin embargo, cambiar la moneda predeterminada no cambiará la moneda de las transacciones existentes: '.config('app.name').' admite el uso de varias monedas al mismo tiempo.',
    ...
    'import-index'           => 'Cualquier archivo CSV se puede importar en '.config('app.name').'. También soporta la importación de datos desde bunq y Spectre. Otros bancos y agregadores financieros se implementarán en el futuro. Sin embargo, como usuario de la demo, solo puede ver el "falso"-proveedor en acción. Generará algunas transacciones aleatorias para mostrarle cómo funciona el proceso.',
