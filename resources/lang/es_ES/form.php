...
return [
    ...
    'user_areYouSure'             => 'Si elimina usuario ":email", todo desaparecerá. No hay deshacer, recuperar ni nada. Si te eliminas, perderás el acceso a esta instancia de '.config('app.name').'.',
    ...
    'permDeleteWarning'           => 'Eliminar cosas de '.config('app.name').' es permanente y no se puede deshacer.',
    ...
    'local_account'         => 'Cuenta '.config('app.name'),
