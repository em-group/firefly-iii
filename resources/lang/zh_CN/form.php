...
return [
    ...
    'user_areYouSure'             => '如果您删除使用者 ":email"，该名使用者的任何资讯均会消失，无法复原。如果您删除自己，将无法进入此 '.config('app.name').' 版本。',
    ...
    'permDeleteWarning'           => '自 '.config('app.name').' 删除项目是永久且不可撤销的。',
    ...
    'local_account'         => config('app.name').' 帐户',
    'from_date'             => '开始自',
    'to_date'               => '日期至',
