...
return [
    ...
    'user_areYouSure'             => 'Если вы удалите пользователя ":email", все данные будут удалены. Это действие нельзя будет отменить. Если вы удалите себя, вы потеряете доступ к этому экземпляру '.config('app.name').'.',
    ...
    'permDeleteWarning'           => 'Удаление информации из '.config('app.name').' является постоянным и не может быть отменено.',
    ...
    'local_account'         => 'Счёт '.config('app.name'),
    'from_date'             => 'От даты',
    'to_date'               => 'До даты',
