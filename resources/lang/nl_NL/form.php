...
return [
    ...
    'user_areYouSure'             => 'Als je gebruiker ":email" verwijdert is alles weg. Je kan dit niet ongedaan maken of ont-verwijderen of wat dan ook. Als je jezelf verwijdert ben je ook je toegang tot deze installatie van '.config('app.name').' kwijt.',
    ...
    'permDeleteWarning'           => 'Dingen verwijderen uit '.config('app.name').' is permanent en kan niet ongedaan gemaakt worden.',
    ...
    'local_account'         => config('app.name').' rekening',
    'from_date'             => 'Datum van',
    'to_date'               => 'Datum tot',
